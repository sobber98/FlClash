...
import 'package:v2box/views/about.dart';
import 'package:v2box/views/access.dart';
import 'package:v2box/views/application_setting.dart';
import 'package:v2box/views/backup_and_restore.dart';
import 'package:v2box/views/config/config.dart';
import 'package:v2box/views/connection/connections.dart';
import 'package:v2box/views/connection/requests.dart';
import 'package:v2box/views/hotkey.dart';
import 'package:v2box/views/logs.dart';
import 'package:v2box/views/profiles/profiles.dart';
import 'package:v2box/views/resources.dart';
