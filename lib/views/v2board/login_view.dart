...
class V2BoardLoginView extends ConsumerStatefulWidget {
  ...
  final bool showRegisterInitially;

  const V2BoardLoginView({
    super.key,
    this.showRegisterAction = true,
    this.showRegisterInitially = false,
  });
...
class _V2BoardLoginViewState extends ConsumerState<V2BoardLoginView> {
  ...
  void initState() {
    super.initState();
    _mode = widget.showRegisterInitially ? _AuthMode.register : _AuthMode.login;
...
class _V2BoardRegisterView extends ConsumerStatefulWidget {
  ...
  ConsumerState<_V2BoardRegisterView> createState() =>
      _V2BoardRegisterViewState();
}

class _V2BoardRegisterViewState extends ConsumerState<_V2BoardRegisterView> {
  late TextEditingController _emailController;
  late TextEditingController _passwordController;
