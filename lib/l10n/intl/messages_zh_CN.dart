...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "installFailed": MessageLookupByLibrary.simpleMessage("启动安装失败，请稍后重试"),
    "installPermissionRequired": MessageLookupByLibrary.simpleMessage(
      "请先允许应用安装未知来源应用，然后重试更新",
    ),
    "installReady": MessageLookupByLibrary.simpleMessage("安装包已准备完成，即将启动安装"),
    ...
    "later": MessageLookupByLibrary.simpleMessage("稍后提醒"),
    ...
    "updateManifestUrl": MessageLookupByLibrary.simpleMessage("更新源地址"),
    ...
    "v2boardActions": MessageLookupByLibrary.simpleMessage("操作"),
    "v2boardBalance": MessageLookupByLibrary.simpleMessage("余额"),
    "v2boardEmailCode": MessageLookupByLibrary.simpleMessage("邮箱验证码"),
    "v2boardEmailSent": MessageLookupByLibrary.simpleMessage("验证码已发送"),
    "v2boardExpire": MessageLookupByLibrary.simpleMessage("到期时间"),
    "v2boardInviteCode": MessageLookupByLibrary.simpleMessage("邀请码"),
    ...
    "v2boardPasswordTip": MessageLookupByLibrary.simpleMessage("密码至少8位"),
    "v2boardRefreshData": MessageLookupByLibrary.simpleMessage("刷新数据"),
    "v2boardRegister": MessageLookupByLibrary.simpleMessage("注册"),
    "v2boardSendCode": MessageLookupByLibrary.simpleMessage("发送"),
    "v2boardServer": MessageLookupByLibrary.simpleMessage("服务器地址"),
    "v2boardServerTip": MessageLookupByLibrary.simpleMessage(
      "请输入以http开头的有效URL",
    ),
    "v2boardSubscription": MessageLookupByLibrary.simpleMessage("订阅"),
    "v2boardSync": MessageLookupByLibrary.simpleMessage("同步"),
    "v2boardSyncSubscription": MessageLookupByLibrary.simpleMessage("同步订阅"),
    "v2boardSyncSubscriptionDesc": MessageLookupByLibrary.simpleMessage(
      "将订阅导入到配置文件",
    ),
    "v2boardSyncSuccess": MessageLookupByLibrary.simpleMessage("订阅同步成功"),
    "value": MessageLookupByLibrary.simpleMessage("值"),
    "verifyFailed": MessageLookupByLibrary.simpleMessage("文件校验失败，请重新下载"),
    "verifyingFile": MessageLookupByLibrary.simpleMessage("正在校验文件..."),
